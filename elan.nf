...
process samtools_quickcheck {
    ...
    echo "\$rv bam ${seqsite} ${coguk_id} ${run_name} ${bam.parent}/${bam}" > ${coguk_id}.${run_name}.bam.quickcheck
    """
}
process fasta_quickcheck {
    ...
    echo "\$rv fasta ${seqsite} ${coguk_id} ${run_name} ${fasta.parent}/${fasta}" > ${coguk_id}.${run_name}.fasta.quickcheck
    """
}
...
process swell {
    ...
    if ( tiles == "1" )
        ...
        echo "\$rv swell ${seqsite} ${coguk_id} ${run_name} ${bam.parent}/${bam}" > ${coguk_id}.${run_name}.swell.quickcheck
