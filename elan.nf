...
process samtools_quickcheck {
    ...
    echo "\$rv bam ${seqsite} ${coguk_id} ${run_name} ${fasta} ${bam}" > ${coguk_id}.${run_name}.bam.quickcheck
    """
}
process fasta_quickcheck {
    ...
    echo "\$rv fasta ${seqsite} ${coguk_id} ${run_name} ${fasta} ${bam}" > ${coguk_id}.${run_name}.fasta.quickcheck
    """
}
